...
import (
	...
	"github.com/Streamfair/streamfair_session_svc/gapi"
...
func main() {
	fmt.Println("Hello, Streamfair Session Management Service!")
...
func runGrpcServer(config util.Config, store db.Store) {
	...
	pb.RegisterSessionManagementServiceServer(grpcServer, server)
...
func runGrpcGatewayServer(config util.Config, store db.Store) {
	...
	err = pb.RegisterSessionManagementServiceHandlerServer(ctx, grpcMux, server)
	if err != nil {
