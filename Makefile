...
PROTO_DIR := ../CommonProto/SessionService/proto
PB_DIR := ../CommonProto/SessionService/pb
SESSION_DIR := session
...
SWAGGER_DOC_NAME := streamfair_session_service
...
proto_core: clean_pb proto_session proto_errors
	protoc \
